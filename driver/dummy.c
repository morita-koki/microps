...
#define DUMMY_MTU UINT16_MAX /* maximu size of IP datagram */
...
dummy_init(void)
{
    ...
    intr_request_irq(DUMMY_IRQ, dummy_isr, INTR_IRQ_SHARED, dev->name, dev); // interrupt(割り込み)用にSIGNALを登録（ダミーだよ）
